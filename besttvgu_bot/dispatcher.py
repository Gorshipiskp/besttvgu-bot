...
from besttvgu_bot.middlewares import UserInfoMiddlewareBase, PerformanceMessageHandler, UserCommandsMiddlewareBase, \
...
def create_dispatcher() -> Dispatcher:
    ...
    dp.message.middleware(UserCommandsMiddlewareBase())
